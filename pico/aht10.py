...
class AHT10:
    def __init__(self, i2c, mode=1, address=AHT10_ADDRESS):
        if i2c is None:
...
if __name__ == "__main__":
    ...
    merica=1
    aht10 = AHT10(i2c, mode=merica)
    
    print(f"Humidity = {aht10.humidity()} and temperature = {aht10.temperature()} with measurement = {aht10.take_measurement()}")