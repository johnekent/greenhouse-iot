...
class APDS9960LITE(I2CEX) :
    ...
    def __init__(self,
        ...
        self.prox.enableSensor()       
        self.als.enableSensor()
    ...
    def take_measurement(self):
        # status of 50 means it's working
        # {'green': 1, 'blue': 1, 'status': 50, 'red': 1, 'ambient': 3}
        
        return {"ambient": self.als.ambientLightLevel,
                "red": self.als.redLightLevel,
                "green": self.als.greenLightLevel,
                "blue": self.als.blueLightLevel,
...
if __name__ == "__main__":
    ...
    """
    print(s.als.ambientLightLevel)
    print(s.als.redLightLevel)
    print(s.als.greenLightLevel)
    print(s.als.blueLightLevel)
    """
