...
class SI1145(object):
    ...
    def take_measurement(self):
        return {"uv": self.read_uv, "visible": self.read_visible, "ir": self.read_ir, "proximity": self.read_prox}
